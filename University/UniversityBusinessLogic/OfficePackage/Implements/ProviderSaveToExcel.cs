...
{
    public class ProviderSaveToExcel : ProviderAbstractSaveToExcel
    {
        ...
        protected override void CreateExcel(ProviderExcelInfo info)
        {
            ...
            _shareStringPart = _spreadsheetDocument.WorkbookPart.GetPartsOfType<SharedStringTablePart>()
                .Any() ? _spreadsheetDocument.WorkbookPart.GetPartsOfType<SharedStringTablePart>()
                .First() : _spreadsheetDocument.WorkbookPart.AddNewPart<SharedStringTablePart>();
        ...
        protected override void SaveExcel(ProviderExcelInfo info)
        {
