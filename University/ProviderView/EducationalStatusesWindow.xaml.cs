...
{
    /// <summary>
    /// Логика взаимодействия для EducationalStatusesWindow.xaml
    /// </summary>
    public partial class EducationalStatusesWindow : Window
    {
        [Dependency]
        public new IUnityContainer Container { get; set; }
        FlowLogic _logic;
        public int _customerId { get; set; }
        public EducationalStatusesWindow(FlowLogic logic)
        {
            InitializeComponent();
            _logic = logic;
        }
