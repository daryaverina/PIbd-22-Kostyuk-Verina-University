...
{
    /// <summary>
    /// Логика взаимодействия для EducationalStatusWindow.xaml
    /// </summary>
    public partial class EducationalStatusWindow : Window
    {
        [Dependency]
        ...
        private int? id;
        public EducationalStatusWindow(FlowLogic logic)
        {
            InitializeComponent();
            _logic = logic;
        }
